...
if __name__ == '__main__':  
    tensor_log_dir = "./tensorboard_logs/DQN_transformer_BM25/"
    save_path = "./model_checkpoints/"
    model_name = "DQN_transformer_BM25"
    ...
    model = DQN.load("model_checkpoints/DQN_transformer_BM25_60000_steps", env=env, tensorboard_log = tensor_log_dir)#, learning_starts=50000, target_update_interval=10000
    model.load_replay_buffer("model_checkpoints/DQN_transformer_BM25_replay_buffer_60000_steps")

    model.learn(total_timesteps=total_timesteps, log_interval=4, callback=checkpoint_callback, reset_num_timesteps = False)

    model.save("DQN_transformer_BM25_"+str(total_timesteps))
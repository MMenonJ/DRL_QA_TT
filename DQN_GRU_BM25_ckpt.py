...
if __name__ == '__main__':  
    ...
    model = DQN.load("model_checkpoints/DQN_GRU_BM25_40000_steps", env=env, tensorboard_log = tensor_log_dir)#, learning_starts=50000, target_update_interval=10000
    model.load_replay_buffer("model_checkpoints/DQN_GRU_BM25_replay_buffer_40000_steps")
